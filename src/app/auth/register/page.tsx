      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_12px_35px_rgba(15,23,42,0.05)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-xs font-extrabold uppercase tracking-[0.14em] text-slate-400">Name</label>
            ...
            <div>
              <label className="text-xs font-extrabold uppercase tracking-[0.14em] text-slate-400">Email</label>
              <div className="relative mt-2">
            ...
            <div>
              <label className="text-xs font-extrabold uppercase tracking-[0.14em] text-slate-400">Password</label>
              <div className="relative mt-2">
